...
function answer(ctx: CredentialContext, result: RefreshResult): Response {
  if (result.refreshed) {
...
export async function handleRefresh(env: ServerEnv, ctx: CredentialContext): Promise<Response> {
