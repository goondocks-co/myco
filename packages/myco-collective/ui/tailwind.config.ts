...
export default {
  ...
  theme: {
    fontFamily: {
      ...
      mono: ['var(--font-data, Geist Mono)', 'ui-monospace', 'monospace'],
    },
    extend: {
      colors: {
        surface: {
      ...
      boxShadow: {
        ambient: '0 24px 48px rgba(var(--shadow-tint), 0.14)',
        glow: '0 0 0 1px rgba(var(--shadow-tint), 0.12), 0 18px 48px rgba(var(--shadow-tint), 0.16)',
      },
    },
  },
  plugins: [],
