...
export async function buildCortexInstructionsInput(
  ...
  return {
    ...
    instruction: [
      ...
      'Focus on teaching how to use Myco retrieval correctly with current, project-relevant guidance.',
      ...
      '- Teach retrieval behavior using the currently available Myco MCP tools.',
