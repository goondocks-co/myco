...
export const TOOL_DEFINITIONS: ToolDefinition[] = [
  ...
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        op: { type: 'string', enum: ['list', 'get'], description: 'Operation (default: "list")' },
        id: { type: 'string', description: 'Skill name, or a generated record id, for op: "get"' },
        status: { type: 'string', description: 'Filter by status: active, stale, retired. Generated records only; a Deployment refuses it.' },
