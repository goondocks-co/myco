import { CORTEX_PATHS, AGENT_PATHS } from './paths.js';
...
const SECTION_RULES: PrefixRule[] = [
  ...
  {
    prefix: 'cortex.instructions',
    page: '/cortex',
    sectionId: CONFIG_SECTION_IDS.cortexInstructions,
    sectionLabel: 'Instructions',
  },
  {
    prefix: 'cortex.spores',
    page: '/cortex',
    sectionId: CONFIG_SECTION_IDS.cortexInstructions,
    sectionLabel: 'Instructions',
  },
  {
    prefix: 'cortex.canopy',
    page: '/cortex',
    sectionId: CONFIG_SECTION_IDS.cortexInstructions,
    sectionLabel: 'Canopy',
    searchParams: { [CONFIG_FOCUS_TAB_PARAM]: 'canopy' },
  },
  {
    prefix: 'cortex.enabled',
    page: '/cortex',
    sectionId: CONFIG_SECTION_IDS.cortexInstructions,
    sectionLabel: 'Instructions',
  },
...
const EXACT_FIELD_LABELS: Record<string, string> = {
  ...
  [CORTEX_PATHS.canopy.minFileBytes]: 'Min File Size (bytes)',
