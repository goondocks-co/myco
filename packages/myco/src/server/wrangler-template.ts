...
# deploy whose only delta is image content pushes a new digest the
# application never adopts. Touch a field here alongside image-only changes
# until the deploy path pins the digest explicitly.
max_instances = 12
