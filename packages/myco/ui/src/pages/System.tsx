...
import { Cpu, RefreshCw, Server, ScrollText, ArrowUpCircle } from 'lucide-react';
  ...
  if (isLoading || !data) {
    return (
      <div className="p-6">
        <PageHeader
          title="System"
          subtitle="Machine-wide settings for the Myco daemon. These apply to every Grove on this machine."
        />
