...
export const SETTINGS_GROUPS: readonly SettingGroup[] = [
  ...
  },
  {
    id: 'okf',
    label: 'OKF',
    desc: 'Publish a portable, repository-carried knowledge wiki (Open Knowledge Format) other agents can read and maintain without Myco.',
    category: 'OKF',
    icon: 'BookOpen',
    fields: [
      {
        ...
        category: 'OKF',
        icon: 'BookOpen',
        note: 'Off by default. Team-shared via the committed myco.yaml — see the OKF page to browse the published wiki once enabled.',
      },
      {
        key: 'okf.maintain.output_path',
        label: 'Output path',
        scope: 'project',
        kind: 'text',
        category: 'OKF',
        icon: 'BookOpen',
        note: 'Bundle output root, relative to the project root.',
      },
      {
        key: 'okf.maintain.scope.repo',
        label: 'Read repository files',
        scope: 'project',
        kind: 'toggle',
        category: 'OKF',
        icon: 'BookOpen',
        note: 'Include the repo file tree as synthesis source material.',
      },
      {
        key: 'okf.maintain.scope.git',
        label: 'Read git history',
        scope: 'project',
        kind: 'toggle',
        category: 'OKF',
        icon: 'BookOpen',
        note: 'Include recent git changes as synthesis source material.',
      },
      {
        key: 'okf.maintain.scope.vault',
        label: 'Read vault knowledge',
        scope: 'project',
        kind: 'toggle',
        category: 'OKF',
        icon: 'BookOpen',
        note: 'Include Myco vault knowledge (spores, decisions, Canopy) as synthesis source material.',
      },
      {
        key: 'okf.maintain.managed_agents_md_pointer',
        label: 'Maintain AGENTS.md pointer',
        scope: 'project',
        kind: 'toggle',
        category: 'OKF',
        icon: 'BookOpen',
        note: 'Keep a managed pointer block in AGENTS.md so coding agents discover the bundle.',
      },
    ],
  },
  {
