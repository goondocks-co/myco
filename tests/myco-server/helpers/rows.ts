...
export function authRow(over: Record<string, unknown> = {}): Record<string, unknown> {
  return {
    ...
    expires_at: 2_000, revoked_at: null,
...
export function noMemberRow(over: Record<string, unknown> = {}): Record<string, unknown> {
  return authRow({ id: null, member_id: null, machine_id: null, expires_at: null, revoked_at: null, lineage_root: null, lineage_started_at: null, predecessor_id: null, first_used_at: null, runtime_label: null, runtime_kind: null, ...over });
}
