...
describe('versioned schema steps', () => {
  ...
  it('applies the project-id grammar as a CHECK on every table created or rebuilt by step 2 that has a project_id column', () => {
    ...
    expect(checked.sort()).toEqual([
      ...
      'attachments', 'blob_reservations', 'blobs', 'canopy_maps', 'cortex_instructions', 'digest_extract_revisions', 'digest_extracts', 'embedding_cursors', 'embedding_hubness_work', 'embedding_receipts', 'embedding_versions', 'external_grants',
