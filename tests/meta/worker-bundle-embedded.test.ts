 ...
 *
 * Measured at 1_424_510 bytes with the recovery schedule and admission owners; the headroom here is smaller than
 * any module an unintended import would add.
 */
const SIZE_CEILING_BYTES = 1_430_000;
