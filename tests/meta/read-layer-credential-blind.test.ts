...
const CORE_MODULES = ['activity.ts', 'canopy.ts', 'blobs.ts', 'children.ts', 'cortex.ts', 'meta.ts', 'plans.ts', 'prompts.ts', 'runs.ts', 'scope.ts', 'search.ts', 'search-types.ts', 'credentials.ts', 'embedding.ts', 'sessions.ts', 'transcript.ts', 'turns.ts'] as const;
