...
describe('housekeeping on the Operations page', () => {
  ...
  it('words the backfill in every state, and its policy', () => {
    ...
    expect(progressWords({ ...base, scheduledTasksEnabled: false, enabled: false, owed: 2 })).toBe('2 ended live sessions waiting for a title. No fully parsed imported sessions are waiting for a title attempt. Automatic titling is off while scheduled intelligence is off; turn that on in Settings.');
