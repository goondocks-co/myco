...
const NO_ISOLATE_NODE_GROUPS = [
  ...
  },
  {
    ...
    targets: [
      ...
      'tests/daemon/graceful-shutdown.test.ts',
      ...
      'tests/daemon/team-sync-fanout.test.ts',
      'tests/daemon/update-checker.test.ts',
  ...
  },
  {
    ...
    targets: [
      ...
      'tests/daemon/task-scheduling.test.ts',
