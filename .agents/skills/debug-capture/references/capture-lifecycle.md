...
Every one of those was a confused boundary. The lesson the audit codified: when investigating, walk this stack top-down with the procedure in this skill's `SKILL.md`. The first layer where the diagnostic check fails is the layer the bug lives in.
